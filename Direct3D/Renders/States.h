...
public:
	enum RasterizerStates {
		...
		WIRE_CULL_ON, WIRE_CULL_OFF, WIRE_CCW, RASTERIZER_END
	};
	enum DepthStencilStates { DEPTH_ON, DEPTH_OFF, DEPTHSTENCIL_END };
	enum SamplerStates { LINEAR, POINT, LINEAR_WRAP, LINEAR_MIRROR, POINT_WRAP, LINEAR_BORDER, POINT_BORDER, SAMPLER_END };
