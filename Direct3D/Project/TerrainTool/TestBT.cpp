...
TestBT::TestBT()
{
	...
	RenderRequest->AddRender("TestBT::UIRender", bind(&TestBT::PostRender, this), RenderType::UIRender);
	RenderRequest->AddRender("TestBT::Render", bind(&TestBT::Render, this), RenderType::Render);

	freeCamera = new FreeCamera;
	Physics::Get()->SetCamera(freeCamera);
