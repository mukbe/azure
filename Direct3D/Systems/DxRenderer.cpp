...
HRESULT DxRenderer::CreateSwapChain(void)
{
	...
	sd.BufferDesc.Width = d3dDesc.Width;				//	후면 버퍼 너비
	sd.BufferDesc.Height = d3dDesc.Height;				//	후면 버퍼 높이
...
void DxRenderer::OnResize()
{
	...
	depthStencilDesc.Width = d3dDesc.Width;		//	너비
	depthStencilDesc.Height = d3dDesc.Height;	//	높이
